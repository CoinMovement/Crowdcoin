...
static const int MASTERNODE_CHECK_SECONDS               =   1;
static const int MASTERNODE_MIN_MNB_SECONDS             =   5 * 60;
static const int MASTERNODE_MIN_MNP_SECONDS             =  10 * 60;
static const int MASTERNODE_EXPIRATION_SECONDS          =  65 * 60 * 10;
static const int MASTERNODE_WATCHDOG_MAX_SECONDS        = 120 * 60 * 10;
static const int MASTERNODE_NEW_START_REQUIRED_SECONDS  = 180 * 60 * 10;

static const int MASTERNODE_POSE_BAN_MAX_SCORE          = 5*10;
