    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Crowdcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Crowdcoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  crowdcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Crowdcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CRC, 0.1 CRC, 1 CRC and 10 CRC -- sort of like the paper money you use every day.</li> \
...
<b>IMPORTANT:</b> Your wallet only contains 1500 of these \"change addresses.\" Every time a mixing event happens, up to 9 of your addresses are used up. \
This means those 1000 addresses last for about 100 mixing events. When 1400 of them are used, your wallet must create more addresses. \
...
For more info see <a href=\"https://crowdcoincoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://crowdcoincoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Crowdcoin Core is shutting down...") + "<br /><br />" +
