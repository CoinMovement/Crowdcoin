...
// - recompile and run "/path/to/test_crowdcoin -t Alert_test"
//
...
BOOST_AUTO_TEST_CASE(AlertApplies)
{
    ...
    BOOST_CHECK(alerts[0].AppliesTo(9914001, ""));
    BOOST_CHECK(alerts[0].AppliesTo(1, "/Satoshi:11.11.11/"));

    BOOST_CHECK(alerts[1].AppliesTo(1, "/Satoshi:0.1.0/"));
    BOOST_CHECK(alerts[1].AppliesTo(9914001, "/Satoshi:0.1.0/"));
    ...
    // Don't match:
    BOOST_CHECK(!alerts[0].AppliesTo(-1, ""));
    BOOST_CHECK(!alerts[0].AppliesTo(9914002, ""));
    ...
    BOOST_CHECK(!alerts[1].AppliesTo(1, "Satoshi:0.1.0/"));
    BOOST_CHECK(!alerts[1].AppliesTo(-1, "/Satoshi:0.1.0/"));
    BOOST_CHECK(!alerts[1].AppliesTo(9914002, "/Satoshi:0.1.0/"));
